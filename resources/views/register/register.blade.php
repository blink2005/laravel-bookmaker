...
@if (! $auth_status)
    ...
    <div class="max-w-xs m-auto mt-[calc(50vh-115px)]">
        <form class="bg-[#141414] shadow-md rounded px-8 pt-6 pb-8" method="POST">
            @csrf
            @if ($errors->any())
                ...
                @endforeach
            @else
                <p class="text-center text-[24px] mb-4">Регистраци аккаунта</p>
            @endif
            <div class="mb-4">
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    name="email" type="email" placeholder="Почта" required>
            </div>
            <div class="mb-4">
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    name="password" type="password" placeholder="Пароль" required>
            </div>

            <div class="mb-4">
                <input
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    name="retry_password" type="password" placeholder="Повторите пароль" required>
            </div>
