...
@if (! $auth_status)
    ...
    @endif
    <main>
        <form target="_blank" class="w-[400px] mt-[126px] mb-[20px] ml-[20px] mr-[20px] bg-[#141414] shadow-md px-8 pt-6 pb-8" method="POST">
            @csrf
            @if ($errors->any())
                ...
                @endforeach
            @else
                <p class="break-words text-[24px] mb-4">Введите сумму пополнения</p>
            @endif
            ...
            <div class="mb-4">
                <input
                    class="text-right bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded focus:outline-none focus:shadow-outline"
