...
@if (! $auth_status)
    ...
    <main>
        <section class="pl-[20px] w-fit mt-[126px]">
            <p class="w-fit text-[24px] font-[700]">Панель администратора</p>
            <a href="{{ route('payments') }}" class="w-fit block mt-[10px] text-[16px] font-[700] text-cyan-500">-> Выплаты пользователям</a>
            <a href="{{ route('create_event') }}" class="w-fit block text-[16px] font-[700] text-cyan-500">-> Создать событие</a>
            <a href="{{ route('edit_event') }}" class="w-fit block text-[16px] font-[700] text-cyan-500">-> Редактировать событие</a>
